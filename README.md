...
| 🔍 **Forensics Agent** | Security & Telemetry | Real-time log forensics, anomaly detection, autonomous threat containment |
...
- 🔍 **[Forensics Agent Runbook](FORENSICS_RUNBOOK.md)** — Learn about the autonomous threat containment pipeline, the JSON schema for forensics logs, and the Tier 3/4 Security Gate.
